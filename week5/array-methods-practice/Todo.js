// In the Todo.js file, use the placeholder To-Do data at https://jsonplaceholder.typicode.com/todos to:
...
const todos = [
  ...
  const filteredUser9List = () => {
    const filtered = todos.filter((el) => el.userId === 9);
    return filtered;
  };

  console.log('Filterd user 9 list',filteredUser9List());


  // then find the number of user 9's incomplete tasks
  const filteredUser9ListIncomplete = () => {
    const filtered = todos
      .filter((el) => el.userId === 9)
      .filter((obj) => !obj.completed);
    return filtered;
  };
  console.log('filteredsuser 9 list incomplete',filteredUser9ListIncomplete());