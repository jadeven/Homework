// In the Post.js file, use the placeholder Post data at https://jsonplaceholder.typicode.com/posts to:
...
// create a list of user 5's posts
  const filteredUser5List = () => {
    const filtered = posts.filter((el) => el.userId === 5);
    return filtered;
  };

  console.log('filtered User 5 list',filteredUser5List())
